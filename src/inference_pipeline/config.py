...
class Settings(BaseSettings):
    ...
    # OpenAI config (also used for any OpenAI-compatible free provider, e.g. Groq or local Ollama)
    ...
    # Set to True (default) to skip AWS SageMaker entirely and call an OpenAI-compatible
    # free provider (Groq, Ollama, etc.) for the final answer generation instead.
    USE_FREE_LLM_FOR_GENERATION: bool = True
